...
import './Login.css';
import LoginLogo from '../../utils/LoginLogo.jsx';
        ...
        <div className="login-body">
            <div className="login-container">
                <div className="login-box">
                    <LoginLogo />
                    <h6 className="login-title">Zaloguj się, aby kontynuować</h6>
                    <form onSubmit={showPasswordField ? handleLogin : handleSubmit}>
                        <div className="form-group">
                            ...
                            />
                            <label htmlFor="email" className={email ? "shrink" : ''}>Wprowadź adres e-mail</label>
                        ...
                        {showPasswordField && (
                            <div className="form-group-x">
                                ...
                                <div className="checkbox-group d-flex">
                                    ...
                                    />
                                    <label htmlFor="receiveInfo" className="receiveInfo">
                                        Tak, chcę otrzymywać informacje i oferty dotyczące produktów firmy Atlassian, związanych z nią wydarzeń i nie tylko.
                                    </label>
                                </div>
                            </div>
                        )}
                        ...
                        <button type="submit" className="login-button">
                            <span className="login-button-text">Kontynuuj</span>
                        </button>
                                <p className="login-different-account">Lub kontynuuj z użyciem konta:</p>
                                <div className="social-buttons">
                                    ...
                                    <button className="social-button apple" type="button">
                                        <img
                                            ...
                                            style={{ marginRight: '12px' }}
                                        />Apple</button>
                                    <button className="social-button slack" type="button">
                                        <img
                        ...
                        <p><a className="login-link" href="#">Nie możesz się zalogować?</a> • <a className="login-link" href="#">Utwórz konto</a></p>
                    </form>
                    <footer className="login-footer">
                    <div className="bottom-logo"><svg viewBox="0 0 190 32" height="24" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                            <defs>
                                <linearGradient x1="99.684716%" y1="15.8138128%" x2="39.8444399%" y2="97.4388388%" id="uid10">
                        ...
                        <p>Jedno konto dla Jira, Confluence, Trello i więcej.</p>
                        <p><a href="#">Polityka prywatności</a> | <a href="#">Powiadomienie użytkownika</a></p>
                        <p>Ta witryna jest chroniona za pomocą zabezpieczenia reCAPTCHA. Obowiązują postanowienia Polityki prywatności oraz Warunków korzystania z usług Google.</p>
                    </footer>
                </div>
            </div>
        </div>
